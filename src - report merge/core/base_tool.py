"""
Secure Base Tool Architecture for Power BI External Tools
Built by Reid Havens of Analytic Endeavors

This architecture provides a clean, secure foundation that reduces false positive
triggers while maintaining professional functionality.
"""
...
class BaseExternalTool(ABC):
    """
    Secure base class for Power BI External Tools
    
    Implements security best practices and provides common functionality
    that reduces false positive triggers in security scanners.
    """
